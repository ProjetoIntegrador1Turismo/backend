...
#
# INSERT INTO
#     tourist_point (id, average_value, long_description, name, short_description, interest_point_type, address_id)
...
#        'Parque Nacional do Iguaçu', 'Uma das sete maravilhas do mundo', 'TOURIST_POINT', 1),
