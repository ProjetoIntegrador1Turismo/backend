...
#
# INSERT INTO
#     experience (id, average_value, long_description, name, short_description, interest_point_type,address_id, duration, required_age,image_cover_url)
# VALUES (30, '150.00', 'O reveillon de Foz do Iguaçu é um dos mais famosos do Brasil. A festa acontece na Avenida Paraná, com shows de artistas nacionais e internacionais, queima de fogos e muita animação.',
#         'Reveillon de Foz do Iguaçu', 'Festa de Ano Novo', 'EVENT', 30, '1 Dia', 'Todas as idades','http://localhost:8081/uploads/interestpointplaceholder.webp'),
#        (31, '50.00', 'O Festival de Dança de Foz do Iguaçu é um evento que reúne bailarinos e coreógrafos de todo o Brasil. Durante o festival, são realizadas apresentações de dança em diversos estilos, como balé clássico, dança contemporânea e dança de salão.',
#         'Festival de Dança de Foz do Iguaçu', 'Evento cultural', 'EVENT', 31, '4 Dias', 'Todas as idades','http://localhost:8081/uploads/interestpointplaceholder.webp'),
#        (32, '200.00', 'Uma seria de shows com vários artitas locais e nacionais em um espaço amplo e confortavel.',
#        'Fespop', 'Festa Popular De Santa Terezinha De Itaipu', 'EVENT', 32, '3 Dias', 'Todas as idades','http://localhost:8081/uploads/interestpointplaceholder.webp'),
#        (33, '45.00', 'Festa em comemoração ao aniversário de Foz do Iguaçu que conta com shows de artistas de renome nacional, feira de artesanatos e alimentos com a participação das entidades assistenciais',
#        'Fartal', 'Feira de Artesanato e Alimentos de Foz do Iguaçu', 'EVENT', 33, '1 Dia', 'Todas as idades','http://localhost:8081/uploads/interestpointplaceholder.webp');
